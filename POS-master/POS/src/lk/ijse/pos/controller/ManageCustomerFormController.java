...
public class ManageCustomerFormController implements Initializable {
    ...
    private void loadAllCustomers() {
        ...
        try {
            ...
            ObservableList<CustomerTM> olCustomers = FXCollections.observableArrayList(customerTM);
    ...
    private void btnDelete_OnAction(ActionEvent event) {
        ...
        if (result.get() == ButtonType.YES) {
            ...
            try {
                ...
                boolean b = new CustomerDAOImpl().deleteCustomer(txtCustomerId.getText());
                if (b) {
                    loadAllCustomers();
                } else {
    ...
    private void btnSave_OnAction(ActionEvent event) {
        ...
        if (addnew) {
            try {
                boolean b = new CustomerDAOImpl().addCustomer(new Customer(txtCustomerId.getText(), txtCustomerName.getText(), txtCustomerAddress.getText()));
                if (b) {
                    loadAllCustomers();
                } else {
            ...
            try {
                boolean b = new CustomerDAOImpl().UpdateCustomer(new Customer(txtCustomerName.getText(), txtCustomerAddress.getText(), txtCustomerId.getText()));
                if (b) {
                    loadAllCustomers();
                } else {
